...
export const Footer: React.FC = () => {
  return (
    <footer className="py-8 sm:py-12 md:py-16 bg-black/30 border-t border-surface-border">
      <Container>
        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8 max-w-3xl mx-auto">
        ...
        <div className="pt-6 sm:pt-8 border-t border-surface-border text-center">
